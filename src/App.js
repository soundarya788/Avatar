...
export default function App() {
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8.5 4.5a.5.5 0 0 0-1 0v5.793L5.354 8.146a.5.5 0 1 0-.708.708l3 3a.5.5 0 0 0 .708 0l3-3a.5.5 0 0 0-.708-.708L8.5 10.293V4.5z"/>
      ...
      <div style={{ marginLeft: '100px', marginTop: '-100px', position: 'absolute' }}>
        ...
        <button style={{ marginLeft: '850px', marginTop: '-90px', position: 'absolute',backgroundColor:'#05c46b' }}onClick={downloadMergedImage} className="btn btn-success">
          Download
        </button>
      </div>
      ...
      <div  style={{marginTop:'-600px',marginLeft:'630px',position:'absolute',fontSize: '30px'}}>
      DreamikAI
      </div>
    </body>
  );
